...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 装填图片数据
	 * 
	 * @param cartRecClassify :
	 * @param imageCycleViewListener
	 */
	public void setImageResources(CartRecClassify cartRecClassify,ImageCycleViewListener imageCycleViewListener) {
		List<CartWork> list;
		if(cartRecClassify!=null){
			 list=cartRecClassify.data;
			if(list.size()<=0){
...
//			list.get(i).title;
//			list.get(i).cover;
			imageNameList.add(list.get(i).title);
			imageUrlList.add(list.get(i).cover);
		}
		// 清除
