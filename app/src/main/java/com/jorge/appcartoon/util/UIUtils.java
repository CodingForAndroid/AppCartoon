...
public class UIUtils {
	...
	public static Context getContext() {
		return CartoonApplication.getApplication();
	}

	public static Thread getMainThread() {
		return CartoonApplication.getMainThread();
	}

	public static long getMainThreadId() {
		return CartoonApplication.getMainThreadId();
	}
	...
	public static Handler getHandler() {
		//获得主线程的looper
		Looper mainLooper = CartoonApplication.getMainThreadLooper();
		//获取主线程的handler
