...
public class DownloadInfo {
     ...
     */
    public static DownloadInfo clone(Chapter  chapter) {
        DownloadInfo downloadInfo = new DownloadInfo();
        downloadInfo.id = chapter.chapter_id;
        downloadInfo.appName = chapter.chapter_title;
        downloadInfo.appSize = chapter.filesize;
        downloadInfo.currentSize = 0;
        downloadInfo.downloadState = DownloadManager.STATE_NONE;
        downloadInfo.url = chapter.getDownloadUrl();
        downloadInfo.path = FileUtils.getDownloadDir() + File.separator + downloadInfo.appName + ".zip";
        return downloadInfo;
    }
